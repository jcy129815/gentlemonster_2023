<header>
        ...
        <div class="right">
            <a href="#" class="lang">Shap in KR</a>
            <form action="#" method="get" id="searchFrm">
                <fieldset>
                    <legend class="skip">검색양식</legend>
                    <input type="text" id="search_text" placeholder="상품명을 검색해주세요">
            ...
            <a href="./login.html" id="login">
                <img src="./images/icon_user.png" alt="로그인">
            </a>
            <a href="./review.html" id="cart">
        ...
        <div id="open_nav">
            ...
            <div class="swiper" id="nav_adver">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="#">무료배송 반품 서비스로 젠틀 몬스터의 서비스를 경험하세요</a>
                    </div>
                </div><!--swiper-wrapper-->
            ...
            <nav>
                ...
                <a href="./product_list.html">브랜드 이슈</a>
                <a href="#">매장보기</a>
